...
int32_t __imported_wasix_32v1_dl_open(int32_t arg0, int32_t arg1, int32_t arg2) __attribute__((
    __import_module__("wasix_32v1"),
    __import_name__("dl_open")
));
...
int32_t __imported_wasix_32v1_dl_load_symbol(int32_t arg0, int32_t arg1, int32_t arg2, int32_t arg3) __attribute__((
    __import_module__("wasix_32v1"),
    __import_name__("dl_load_symbol")
));
...
__wasi_errno_t __wasi_dl_load_symbol(
    ...
    int32_t ret = __imported_wasix_32v1_dl_load_symbol((intptr_t) symbol, (intptr_t) symbol_len, (int32_t) handle, (intptr_t) retptr0);
    return (uint16_t) ret;
}

int32_t __imported_wasix_32v1_dl_close(int32_t arg0) __attribute__((
    __import_module__("wasix_32v1"),
    __import_name__("dl_close")
));
